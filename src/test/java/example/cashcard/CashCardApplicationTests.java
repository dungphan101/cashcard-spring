...
class CashCardApplicationTests {
    ...
    void shouldNotReturnACashCardWithAnUnknownId() {
        ResponseEntity<String> response = restTemplate
                .withBasicAuth("sarah1", "abc123")
                .getForEntity("/cashcards/100000", String.class);
    ...
    void shouldNotReturnACashCardWhenUsingBadCredentials() {
        ResponseEntity<String> respone = restTemplate
                ...
                .getForEntity("/cashcards/99", String.class);
        assertThat(respone.getStatusCode()).isEqualTo(HttpStatus.UNAUTHORIZED);

        respone = restTemplate
    ...
    @Test
    void shouldNotAllowAccessToCashCardsWhenTheyDoNotOwn() {
        ResponseEntity<String> response = restTemplate
                .withBasicAuth("sarah1", "abc123")
    ...
    void shouldNotDeleteACashCardThatDoesNotExist() {
        ResponseEntity<Void> response = restTemplate
                .withBasicAuth("sarah1", "abc123")
                .exchange("/cashcards/88888899", HttpMethod.DELETE, null, Void.class);
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
    }
